        ...
        <?php else: ?>
            ...
            <div class="row g-3 mb-4">
                ...
                <?php foreach ($situations as $s): ?>
                    ...
                    <?php $totalGeneral += (float)$s['montant_total']; ?>
                    ...
                    <div class="col-md-3">
                        <div class="card text-white bg-info p-3 text-center">
                            ...
                            <div class="display-6 fw-bold">
                                <?= number_format((float)$s['montant_total'], 2, ',', ' ') ?> Ar
                            </div>

                            <div>
                                <?= (int)$s['nb_transferts'] ?> transfert(s)
                            </div>

                            <small>
                                Dernier : <?= esc($s['derniere_operation'] ?? '') ?>
                            </small>
                        </div>
                    </div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php foreach ($situations as $s): ?>
                            <tr>
                                <td>
                                    <strong><?= esc($s['operateur_nom'] ?? '') ?></strong>
                                </td>
